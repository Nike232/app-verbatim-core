...
Compares the newest two versions that meet `minVersionReviews`. The structured result contains `pass`, `fail`, or `insufficient-data`, selected versions, policy, metric changes, violations, and source-review evidence.
